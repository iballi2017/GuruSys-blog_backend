...
const postJoiSchema = joi_1.default.object({
    title: joi_1.default.string().required().optional(),
    body: joi_1.default.string().email().required(),
    author: joi_1.default.string().optional(),
});
exports.default = {
    ValidatePost: postJoiSchema,
    BlogPost: mongoose_1.default.model('BlogPost', PostSchema),
};
